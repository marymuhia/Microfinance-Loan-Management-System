...
<center>
<h2>Microfinance Loan manahement system</h2>
</center>
</div>
</div>
...
<div class="mainn">
  <table border="0" align="center">
    ...
    <?php do { ?>
      <tr>
        <td><a href="pendlons.php?recordID=<?php echo $row_Recordset1['loanId']; ?>"> <?php echo $row_Recordset1['loanId']; ?>&nbsp; </a></td>
        ...
        <td><?php echo $row_Recordset1['bankStatementPhoto']; ?>&nbsp; </td>
        <td><?php echo $row_Recordset1['security']; ?>&nbsp; </td>
        <td><?php echo $row_Recordset1['posting_date']; ?>&nbsp; </td>
        <td><font color="#0099FF"><?php echo $row_Recordset1['status']; ?></font>&nbsp; </td>
       <td><a href="approveloan.php?loanId=<?php echo $row_Recordset1['loanId']; ?>" style="text-decoration:none"><font color="#3366FF">Approve/Unapprove</font></a></td>
      </tr>
