...
<div class="mainn">
  <table border="0" align="center">
    ...
    <?php do { ?>
      <tr>
        <td><a href="approvedlons.php?recordID=<?php echo $row_Recordset1['loanId']; ?>"> <?php echo $row_Recordset1['loanId']; ?>&nbsp; </a></td>
        ...
        <td><font color="#0000FF"><?php echo $row_Recordset1['status']; ?></font>&nbsp; </td>
      </tr>
