...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO loantype (loanType, `description`) VALUES (%s, %s)",
...
<label for="loanType"><b>Loan type:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></label>
    <input type="text"  placeholder="Enter loan type" name="loanType" required>
   <br/>  <br/>
    <label for="description"><b>Description:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></label>
    <textarea name="description" cols="" rows="" placeholder="Enter description" required="required"></textarea>
    <br/>
