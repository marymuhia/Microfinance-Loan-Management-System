...
$Recordset2 = mysql_query($query_Recordset2, $mlms) or die(mysql_error());
...
<tr>
<td align="center" ><a href="displaymember.php" title="click to view your Members" style="text-decoration:none"><img src="../Photos/customer.jpg"  height="180px" width="180px"/><br />
Total members &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $totalRows_Recordset1 ?></a></td>

<td align="center"><a href="displayloantype.php" title="click to view loan type" style="text-decoration:none"><img src="../Photos/loan.png" height="180px" width="180px"/><br />Total loan type&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $totalRows_Recordset2 ?> </a></td>

<td align="center"><a href="reports.php" title="click to view customers Reports" style="text-decoration:none"><img src="../Photos/reports.png" height="140px" width="140px"/><br />Reports</a></td></tr>
</table>
